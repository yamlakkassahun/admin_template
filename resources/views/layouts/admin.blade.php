                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right py-0"
                                ...
                                <div class="list-group">
                                    <a href="#" class="list-group-item">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-2">
                                                <img src="<?php echo url('/'); ?>/assets/img/avatars/avatar-5.jpg"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-2">
                                                <img src="<?php echo url('/'); ?>/assets/img/avatars/avatar-2.jpg"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-2">
                                                <img src="<?php echo url('/'); ?>/assets/img/avatars/avatar-4.jpg"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-2">
                                                <img src="<?php echo url('/'); ?>/assets/img/avatars/avatar-3.jpg"
